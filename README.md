...
-- ============================================
-- TELA DE CARREGAMENTO (MAIS LENTA)
-- ============================================
...
LoaderContainer.Size = UDim2.new(0, 450, 0, 300)
LoaderContainer.Position = UDim2.new(0.5, -225, 0.5, -150)
...
LoaderTitle.Position = UDim2.new(0, 0, 0, 120)
...
VersionText.Text = "v" .. Lunaris.Version .. " 🌙"
...
-- Carregamento MAIS LENTO (0.5s cada etapa)
local loadSteps = {
    {text = "Inicializando sistemas...", progress = 10},
    {text = "Carregando interface...", progress = 25},
    {text = "Configurando Aimbot...", progress = 40},
    {text = "Carregando ESP...", progress = 55},
    {text = "Ativando Caixinha 2D...", progress = 70},
    {text = "Configurando Anti-Team...", progress = 85},
    {text = "Pronto! 🌙", progress = 100}
}

for _, step in ipairs(loadSteps) do
    LoaderSubtitle.Text = step.text
    TweenService:Create(ProgressBar, TweenInfo.new(0.5), {Size = UDim2.new(step.progress/100, 0, 1, 0)}):Play()
    task.wait(0.5)
end
...
local windowWidth = isMobile and 380 or 800
local windowHeight = isMobile and 550 or 600
...
HubIcon.Position = UDim2.new(0, 15, 0.5, -15)
...
HubTitle.Text = "LUNARIS HUB 🌙"
HubTitle.TextColor3 = Theme.TextColor
HubTitle.TextSize = isMobile and 18 or 22
HubTitle.TextXAlignment = Enum.TextXAlignment.Left
HubTitle.Font = Enum.Font.GothamBold
HubTitle.Parent = Topbar

local TopbarVersion = Instance.new("TextLabel")
TopbarVersion.Size = UDim2.new(0, 120, 1, 0)
TopbarVersion.Position = UDim2.new(0, 300, 0, 0)
TopbarVersion.BackgroundTransparency = 1
TopbarVersion.Text = "v" .. Lunaris.Version
TopbarVersion.TextColor3 = Theme.TextColor
TopbarVersion.TextTransparency = 0.3
TopbarVersion.TextSize = isMobile and 12 or 14
...
local tabWidth = isMobile and 75 or 170
...
for i, tab in ipairs(Tabs) do
    ...
    btn.Position = UDim2.new(0, 5 + (i-1) * (tabWidth + 5), 0, 5)
...
ContentArea.ScrollBarThickness = isMobile and 4 or 6
...
-- FUNÇÃO CORRIGIDA PARA CRIAR FOV CIRCLE
...
-- FUNÇÃO CORRIGIDA PARA CRIAR FOV 4D CIRCLE
...
-- ATUALIZAR POSIÇÃO DO FOV QUANDO A TELA REDIMENSIONAR
...
function CreateSection(title)
    ...
    section.Size = UDim2.new(0, isMobile and 350 or 740, 0, 30)
    section.BackgroundTransparency = 1
    section.Parent = ContentArea
    
    local line = Instance.new("Frame")
    line.Size = UDim2.new(1, -20, 0, 2)
    line.Position = UDim2.new(0, 10, 0, 25)
...
function CreateToggle(data)
    ...
    toggle.Size = UDim2.new(0, isMobile and 350 or 740, 0, 45)
    ...
    toggleBg.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
            ...
            toggleCircle.Position = state and UDim2.new(1, -24, 0.5, -10) or UDim2.new(0, 4, 0.5, -10)
            callback(state)
            ShowNotification("⚙️ " .. title, state and "Ativado!" or "Desativado!", 1)
        end
    end)
...
function CreateSlider(data)
    ...
    slider.Size = UDim2.new(0, isMobile and 350 or 740, 0, 70)
    ...
    valueLabel.TextSize = isMobile and 16 or 16
    ...
    sliderBg.InputEnded:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
            dragging = false
            ShowNotification("⚙️ " .. title, "Valor: " .. currentValue .. suffix, 1)
        end
    end)
...
function CreateColorPicker(data)
    ...
    picker.Size = UDim2.new(0, isMobile and 350 or 740, 0, 55)
    ...
    colorDisplay.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
            ...
            ShowNotification("🎨 " .. title, "Cor alterada!", 1)
        end
    end)
...
function CreateButton(data)
    ...
    button.Size = UDim2.new(0, isMobile and 180 or 200, 0, 40)
    ...
    button.MouseButton1Click:Connect(function()
        callback()
        ShowNotification("✨ Ação", title .. " executado!", 1.5)
    end)
...
function CreateParagraph(data)
    ...
    para.Size = UDim2.new(0, isMobile and 350 or 740, 0, isMobile and 120 or 90)
    ...
    titleLabel.TextSize = isMobile and 16 or 16
    titleLabel.TextXAlignment = Enum.TextXAlignment.Left
    titleLabel.Font = Enum.Font.GothamBold
    titleLabel.Parent = para
    
    local contentLabel = Instance.new("TextLabel")
    contentLabel.Size = UDim2.new(1, -30, 0, isMobile and 70 or 45)
    contentLabel.Position = UDim2.new(0, 15, 0, 35)
    contentLabel.BackgroundTransparency = 1
    contentLabel.Text = content
    contentLabel.TextColor3 = Theme.TextColor
    contentLabel.TextSize = isMobile and 12 or 13
...
function CreateDivider()
    ...
    divider.Size = UDim2.new(0, isMobile and 330 or 700, 0, 1)
...
function UpdateTabContent(tabId)
    -- LIMPAR TODO CONTEÚDO ANTES DE CRIAR NOVO
    ...
    elseif tabId == "Credits" then
        ...
        CreateParagraph({
            Title = "Lunaris Hub v" .. Lunaris.Version,
            Content = "Desenvolvido por " .. Lunaris.Developer .. "\n\n" ..
                      "✓ Speed: 0-15 studs\n" ..
                      "✓ Aimbot Supremo: Força 1-10\n" ..
                      "✓ Aimbot 4D Rápido\n" ..
...
-- ============================================
-- BOTÃO DE MINIMIZAR (SÍMBOLO ESPECIAL)
-- ============================================
...
MinimizeBtn.MouseButton1Click:Connect(function()
    ...
    moonBtn.Size = UDim2.new(0, 60, 0, 60)
    moonBtn.Position = UDim2.new(0, 20, 0, 20)
    moonBtn.BackgroundTransparency = 1  -- COMPLETAMENTE TRANSPARENTE
    moonBtn.Text = "⦿"  -- SÍMBOLO ESPECIAL (bola com ponto no meio)
...
task.wait(0.5)
ShowNotification("✨ Lunaris Hub", "Menu carregado! Pressione K", 3)
